...
use sea_query::{BinOper, ColumnRef, Condition, ExprTrait as _, SimpleExpr, Value};
...
fn my_to_sea_condition(col: &ColumnRef, op_val_value: OpValValue) -> SeaResult<Condition> {
